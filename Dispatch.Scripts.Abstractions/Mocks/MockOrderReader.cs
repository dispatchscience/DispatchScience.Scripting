...
{
    public class MockOrderReader : IOrderReader
    {
        ...
        public MockOrderGroupReader[] OrderGroups { get; set; } = [];
    ...
    public class MockPayoutReader : IPayoutReader
    {
        public PayoutInfo PayoutInfo { get; set; } = new();
    }

    public class MockWorkflowReader : IWorkflowReader
    {
        ...
        public class MockWorkflowStepReader : IWorkflowReader.IWorkflowStepReader
        {
            public string Id { get; set; } = default!;
    ...
    public class MockOrderGroupReader : IOrderGroupReader
    {
        ...
        public void SetDebugWrapper(ScriptDebugWrapper debugWrapper)
        {
            _debugWrapper = debugWrapper;
        }

        async Task<IOrderGroupDetailReader> IOrderGroupReader.GetDetail()
        {
            await Task.CompletedTask;
            return _debugWrapper.GetOrderGroupDetail<MockOrderGroupDetailReader>(Id)!;
        }
    }

    public class MockOrderGroupDetailReader : IOrderGroupDetailReader
    {
        public string Id { get; set; } = default!;
        public string Key { get; set; } = default!;
        ...
        public bool IsActive { get; set; }
        public MockOrderGroupItemReader[] Items { get; set; } = [];

        IOrderGroupItemReader[] IOrderGroupDetailReader.Items => Items;
    }

    public class MockOrderGroupItemReader : IOrderGroupItemReader
    {
